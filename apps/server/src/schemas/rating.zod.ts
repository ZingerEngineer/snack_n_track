import { z } from 'zod'
import { TRatingType, TRatingScale } from '../types/rating.types'

// Rating System Schemas
export const RatingTypeSchema = z.nativeEnum(TRatingType)
export const RatingScaleSchema = z.nativeEnum(TRatingScale)
