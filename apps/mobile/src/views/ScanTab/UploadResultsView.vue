  ...
  <IonPage>
    <IonContent>
      <div
        ...
        class="tool-bar-safe-margin w-full px-8 flex justify-center items-center flex-col gap-6"
      >
        <img
          v-if="scanStore.imagePath"
          :src="scanStore.imagePath ? scanStore.imagePath : ''"
          class="aspect-square rounded-lg shadow-lg border-2 border-primary mt-4"
        />
        <div class="flex flex-col gap-6 w-full justify-center">
          ...
          >
            ...
            >
              ...
              <FontAwesomeIcon class="text-primary text-lg" :icon="faCircleCheck"></FontAwesomeIcon>
            </div>
            <IonCardHeader>
